...
function Records() {
    ...
    //data categories içindeki değerin ismi categories de yeni vermek istediğimiz isim
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: "category",
            key: "category",
            //birinci parametre verinin içerisinde category keyinin getirdiği veri, ikinci parametre kayıt satırının tamamı
    ...
    //eğer formun ismi yoksa, amount değeri sıfıra eşitse ve categoryıd sıfıra eşitse form valid değil
    const isFormValid = !(
        !form.title || 
        form.amount ===0 || 
        form.category_id ===0); //false döndürürse form valid değil
    ...
    return (
        <React.Fragment>
                    ...
                    {mode === "edit" || mode === "new" ?
                        <Form labelCol={{ span: 8 }} wrapperCol={{ span: 16 }}>
                            ...
                            <Form.Item label="Category">
                                <Select defaultValue={form.category_id}
            ...
            {/* rowkey sayesinde her bir satırı birbirinden ayırmak için kullanılacak olan obje içerisindeki değer ismi verilir */}
